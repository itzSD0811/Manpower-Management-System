...
export interface PrepaymentEntity {
  id: string; // UUID
  type: 'salary_advance' | 'other';
  month: string; // YYYY-MM
  employeeId: string;
  amount: number;
  reason?: string; // Only for 'other' type
  createdAt?: string; // ISO date string (optional, auto-generated by MySQL)
}
